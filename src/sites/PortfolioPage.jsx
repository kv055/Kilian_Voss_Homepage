      ...
      >
        ...
        <div className="m-2 md:m-8 bg-slate-300 h-screen max-w-screen-xl rounded-xl opacity-60 justify-center text-center p-2 xl:p-10">
          ...
          <div className="flex flex-col text-center">
            ...
            <div className="m-5 md:m-10 bg-white h-screen rounded-xl overflow-auto">
              <div className="border-y-4 border-indigo-500 py-5 my-5">
                <div className="grid grid-cols-4 gap-4 grid-rows-3 ">
                  <h3 className="Orbitron font-bold text-lg tracking-wide col-span-4">
